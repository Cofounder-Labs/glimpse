...
export default function V0Interface() {
  ...
  // Preview state removed, we'll go directly to editor
      ...
      <div className={`transition-all duration-300 w-full`}>
        {showInitialUI ? (
          <div className="container mx-auto px-4 py-16 flex flex-col items-center">
            ...
            {/* Input Box - Improved to match image better */}
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-16">
              <button className="flex items-center gap-2 px-4 py-2 rounded-full border hover:bg-gray-50">
                ...
                <span>A demo of my new Docs</span>
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-full border hover:bg-gray-50">
                <Users className="w-4 h-4" />
                <span>Onboarding flow walkthrough</span>
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-full border hover:bg-gray-50">
                <Settings className="w-4 h-4" />
                <span>Admin panel in action</span>
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-full border hover:bg-gray-50">
                <ShoppingCart className="w-4 h-4" />
                <span>Self-serve checkout flow</span>
              </button>
            </div>
